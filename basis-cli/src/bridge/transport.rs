...
//!
//! That agreement is why the bridge calls [`serve`](basis_acp::serve)
//! directly instead of spawning a `basis` subprocess and copying bytes between
