...
//! travel *to* the harness as a script. lan's bet is the inverse: the harness
...
//! with a real debugger behind it. Nothing below is interpreted by lan.
//!
...
//! cargo run -p lan-core --example review_workflow -- /repo "the parser in src/lex.rs" 200000
//! ```
...
/// fan-out open — and unset by default everywhere in lan, because no unattended
...
/// alike: one is lan telling the host something went wrong, the other is a turn
