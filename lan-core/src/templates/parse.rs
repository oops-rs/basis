...
//!
//! The delimiter rules are markdown frontmatter's, not lan's: a leading `---`
...
/// The keys lan reads. Unknown keys are left alone — a template written for a
/// newer lan, or for another harness, should still load here.
#[derive(Debug, Clone, Default, Deserialize)]
pub struct Frontmatter {
    pub description: Option<String>,
    /// `argument-hint` is the spelling the convention uses. The underscore
    /// form is accepted too, because YAML tempts people into it and a key lan
