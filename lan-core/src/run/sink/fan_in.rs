...
//! not a DSL lan interprets. What that leaves open is the other direction. Each
...
//! use lan_core::{EventFanIn, Workspace};
//!
...
//!     Ok::<_, lan_core::RunError>((survey?.final_message, coverage?.final_message))
//! };
//! let watch = async {
