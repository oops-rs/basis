//! lan's own tools — the native binding of ADR-0012's tool contract.
//!
...
//!
//! There is no `WorkspaceBuilder::with_tool`. Registering *lan's* tool needs
...
//! `Arc`, and so lan would have to hand-forward all seven of `ToolExecutor`'s
