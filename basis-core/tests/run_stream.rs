...
async fn the_header_reports_the_context_that_was_loaded() {
    ...
    assert_eq!(*schema, basis_core::EVENT_SCHEMA_VERSION);
    ...
    let session = mock
        ...
        .create_session_with_config(
            ...
            mentra::agent::AgentConfig {
                system: basis_core::WorkspaceContext::discover_with(
                    workspace.path(),
                    &basis_core::ContextConfig {
                        file_name: "AGENTS.md".to_string(),
                        global_dir: None,
                        walk_parents: false,
                    },
...
async fn the_jsonl_rendering_is_one_parseable_object_per_line() {
    ...
    assert_eq!(lines[0]["schema"], basis_core::EVENT_SCHEMA_VERSION);
