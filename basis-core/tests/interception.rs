...
#[cfg(unix)]
use basis_core::HookSpec;
use basis_core::{HookOutcome, HookRequest, HookRunner, Interceptor, InterceptorError};
...
impl Scenario {
    ...
    /// which is exactly how [`basis_core::WorkspaceBuilder::open`] installs it.
