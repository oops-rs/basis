//! basis-core — the in-process SDK of [basis](https://github.com/oops-rs/basis), an
...
//!
//! ```no_run
//! # async fn example() -> Result<(), basis_core::RunError> {
...
// mentra to your manifest, pinned to whatever version basis-core happens to
