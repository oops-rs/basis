...
//! under it. They build their [`ServeConfig`](lan_acp::ServeConfig) from the
...
//! that in one more "lan: " would only make it longer.

use std::process::ExitCode;

use lan_acp::StdioError;
use lan_core::{RunConfig, ShellAccess, provider};
