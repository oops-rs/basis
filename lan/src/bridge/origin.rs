...
//!   which could have run `lan` itself; refusing it protects nothing.
...
/// lan can make: the error *is* the HTTP response the client gets, and it is
...
fn refused() -> ErrorResponse {
    HttpResponse::builder()
        ...
        .body(Some(
            "lan: this bridge does not serve web pages unless their origin is \
