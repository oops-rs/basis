...
//! outrank the same name in a `.mcp.json`, and a transport lan cannot serve has
...
use lan_acp::from_acp;
use lan_core::mcp::{DEFAULT_WORKSPACE_MCP_FILE, McpConfig, servers};
